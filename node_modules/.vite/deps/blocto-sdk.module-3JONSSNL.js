...
var EthereumProvider = class extends BloctoProvider {
  ...
  async handleReadRequests(payload) {
    ...
    return fetch(this.rpc, {
      ...
      body: JSON.stringify(__spreadValues({ id: 1, jsonrpc: "2.0" }, payload))
    ...
    try {
      ...
      switch (payload.method) {
        ...
        case "getAccountInfo": {
          ...
          result = __spreadProps(__spreadValues({}, accountInfo.result.value), {
...
var BloctoSDK = class {
  constructor({ appId, ethereum, solana }) {
    if (ethereum) {
      this.ethereum = new EthereumProvider(__spreadProps(__spreadValues({}, ethereum), { appId }));
    }
    if (solana) {
      this.solana = new SolanaProvider(__spreadProps(__spreadValues({}, solana), { appId }));
    }
  }
};
...
//# sourceMappingURL=blocto-sdk.module-3JONSSNL.js.map
