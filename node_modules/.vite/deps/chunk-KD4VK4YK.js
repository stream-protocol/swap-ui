...
var WalletProvider = ({ children, wallets: adapters, autoConnect = false, onError, localStorageKey = "walletName" }) => {
    ...
    function handleReadyStateChange(readyState2) {
      setWallets((prevWallets) => {
        ...
        return [
          ...
          __spreadProps(__spreadValues({}, prevWallets[walletIndex]), { readyState: readyState2 }),
  ...
  const handleConnect = (0, import_react6.useCallback)(() => {
    if (!adapter)
      return;
    setState((state) => __spreadProps(__spreadValues({}, state), { connected: adapter.connected, publicKey: adapter.publicKey }));
  }, [adapter]);
...
//# sourceMappingURL=chunk-KD4VK4YK.js.map
